...
installfiles = {"*.sty"}
sourcefiles = {"*.sty"}  
excludefiles = {"documentation.pdf","test.pdf","beamertheme-rainbow-doc-listing-*.pdf"}
...
uploadconfig = {
  ...
  license      = "lppl1.3c",
  summary      = "Beamer colour theme with alternating theme colours",
...
-- cleanup ===========================================================
cleanfiles = {"beamertheme-rainbow-ctan.curlopt", "beamertheme-rainbow-ctan.zip", "beamertheme-rainbow-doc-listing-*"}
